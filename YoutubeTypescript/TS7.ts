...
if (typeof data === "object" && data !== null && 'name' in data) {
    console.log("Fetched Data Name: ", (data as { name: string }).name);
}
//explain (data as { name: string }).name);
// here we are asserting that data is of type { name: string } to access the name property safely.
